...
import User__user_profile_header, {
  ReadOutType as User__user_profile_header__outputType,
} from "./User__user_profile_header.isograph";
import User__user_profile_with_details, {
  ReadOutType as User__user_profile_with_details__outputType,
} from "./User__user_profile_with_details.isograph";

const queryText =
  "query user_detail_page ($id: ID!) {\
