...
import type {ReadFromStoreType, Query__UserPage__param, ReadOutType} from './reader';
...
const artifact: IsographEntrypoint<ReadFromStoreType, Query__UserPage__param, ReadOutType> = {
  kind: "Entrypoint",
  queryText,
  normalizationAst,
