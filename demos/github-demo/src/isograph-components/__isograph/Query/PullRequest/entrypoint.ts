...
import type {Query__PullRequest__param, ReadOutType} from './reader';
...
const artifact: IsographEntrypoint<Query__PullRequest__param, Query__PullRequest__param, ReadOutType> = {
  kind: "Entrypoint",
  queryText,
  normalizationAst,
