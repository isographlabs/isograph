...
import type {ReadFromStoreType, Query__PullRequest__param, ReadOutType} from './reader';
...
const artifact: IsographEntrypoint<ReadFromStoreType, Query__PullRequest__param, ReadOutType> = {
  kind: "Entrypoint",
  queryText,
  normalizationAst,
