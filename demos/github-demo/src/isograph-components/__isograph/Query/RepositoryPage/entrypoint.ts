...
import type {Query__RepositoryPage__param, ReadOutType} from './reader';
...
const artifact: IsographEntrypoint<Query__RepositoryPage__param, Query__RepositoryPage__param, ReadOutType> = {
  kind: "Entrypoint",
  queryText,
  normalizationAst,
