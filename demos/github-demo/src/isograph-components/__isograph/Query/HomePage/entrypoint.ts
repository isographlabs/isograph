...
import type {ReadFromStoreType, Query__HomePage__param, ReadOutType} from './reader';
...
const artifact: IsographEntrypoint<ReadFromStoreType, Query__HomePage__param, ReadOutType> = {
  kind: "Entrypoint",
  queryText,
  normalizationAst,
