...
export function iso<T>(
        ...
        ): IdentityWithParam<typeof entrypoint_Query__UserPage>;
export function iso<T>(
            param: T & MatchesWhitespaceAndString<'entrypoint Query.RepositoryPage', T>
        ): IdentityWithParam<typeof entrypoint_Query__RepositoryPage>;
export function iso<T>(
            param: T & MatchesWhitespaceAndString<'entrypoint Query.HomePage', T>
        ): IdentityWithParam<typeof entrypoint_Query__HomePage>;
export function iso<T>(
            param: T & MatchesWhitespaceAndString<'entrypoint Query.PullRequest', T>
        ): IdentityWithParam<typeof entrypoint_Query__PullRequest>;
