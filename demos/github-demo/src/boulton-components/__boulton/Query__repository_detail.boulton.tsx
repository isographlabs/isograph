...
import PullRequestConnection__pull_request_table, { ReadOutType as PullRequestConnection__pull_request_table__outputType } from './PullRequestConnection__pull_request_table.boulton';
