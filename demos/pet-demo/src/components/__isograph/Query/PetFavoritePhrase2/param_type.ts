...
import type { Query__PetFavoritePhrase2__parameters } from './parameters_type';

export type Query__PetFavoritePhrase2__param = {
  readonly data: {
    /**
Fetch a pet by id
    */
...
It's probably something from David Foster Wallace or Dostoevsky, keep up.
  ...
  readonly parameters: Query__PetFavoritePhrase2__parameters,
};
