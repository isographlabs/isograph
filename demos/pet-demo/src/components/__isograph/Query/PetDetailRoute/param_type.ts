...
import { type Pet__PetTaglineTestCard__output_type } from '../../Pet/PetTaglineTestCard/output_type';
...
export type Query__PetDetailRoute__param = {
  readonly data: {
    readonly pet: ({
      ...
      readonly PetTaglineTestCard: Pet__PetTaglineTestCard__output_type,
