...
import type {ReadFromStoreType, Query__PetDetailRoute__param, ReadOutType} from './reader';
...
const artifact: IsographEntrypoint<ReadFromStoreType, Query__PetDetailRoute__param, ReadOutType> = {
  kind: "Entrypoint",
  queryText,
  normalizationAst,
