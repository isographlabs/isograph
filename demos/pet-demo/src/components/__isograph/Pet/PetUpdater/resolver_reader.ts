...
import Pet____refetch from '../__refetch/refetch_reader';
import Pet__set_best_friend from '../set_best_friend/refetch_reader';
import Pet__set_pet_tagline from '../set_pet_tagline/refetch_reader';
