...
export type ReadFromStoreType = Pet__set_pet_best_friend__param;
...
export type Pet__set_pet_best_friend__param = {
  id: string,
};
...
const artifact: ReaderArtifact<ReadFromStoreType, Pet__set_pet_best_friend__param, ReadOutType> = {
  kind: "ReaderArtifact",
