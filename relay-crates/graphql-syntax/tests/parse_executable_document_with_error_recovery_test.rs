...
async fn argument_missing_value() {
    let input = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/argument-missing-value.graphql"
    );
    let expected = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/argument-missing-value.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "argument-missing-value.graphql",
        "parse_executable_document_with_error_recovery/fixtures/argument-missing-value.expected",
        input,
        expected,
    )
...
async fn argument_missing_value_2() {
    let input = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/argument-missing-value-2.graphql"
    );
    let expected = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/argument-missing-value-2.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "argument-missing-value-2.graphql",
        "parse_executable_document_with_error_recovery/fixtures/argument-missing-value-2.expected",
        input,
        expected,
    )
...
async fn argument_name_only() {
    let input = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/argument-name-only.graphql"
    );
    let expected = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/argument-name-only.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "argument-name-only.graphql",
        "parse_executable_document_with_error_recovery/fixtures/argument-name-only.expected",
        input,
        expected,
    )
...
async fn argument_name_only_2() {
    let input = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/argument-name-only-2.graphql"
    );
    let expected = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/argument-name-only-2.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "argument-name-only-2.graphql",
        "parse_executable_document_with_error_recovery/fixtures/argument-name-only-2.expected",
        input,
        expected,
    )
...
async fn argument_value_only() {
    let input = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/argument-value-only.graphql"
    );
    let expected = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/argument-value-only.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "argument-value-only.graphql",
        "parse_executable_document_with_error_recovery/fixtures/argument-value-only.expected",
        input,
        expected,
    )
...
async fn argument_value_only_2() {
    let input = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/argument-value-only-2.graphql"
    );
    let expected = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/argument-value-only-2.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "argument-value-only-2.graphql",
        "parse_executable_document_with_error_recovery/fixtures/argument-value-only-2.expected",
        input,
        expected,
    )
...
async fn argument_value_only_3() {
    let input = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/argument-value-only-3.grahql"
    );
    let expected = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/argument-value-only-3.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "argument-value-only-3.grahql",
        "parse_executable_document_with_error_recovery/fixtures/argument-value-only-3.expected",
        input,
        expected,
    )
...
async fn directive_without_name() {
    let input = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/directive-without-name.graphql"
    );
    let expected = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/directive-without-name.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "directive-without-name.graphql",
        "parse_executable_document_with_error_recovery/fixtures/directive-without-name.expected",
        input,
        expected,
    )
...
async fn empty_argument_list() {
    let input = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/empty-argument-list.graphql"
    );
    let expected = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/empty-argument-list.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "empty-argument-list.graphql",
        "parse_executable_document_with_error_recovery/fixtures/empty-argument-list.expected",
        input,
        expected,
    )
...
async fn empty_linked_field() {
    let input = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/empty-linked-field.graphql"
    );
    let expected = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/empty-linked-field.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "empty-linked-field.graphql",
        "parse_executable_document_with_error_recovery/fixtures/empty-linked-field.expected",
        input,
        expected,
    )
...
async fn type_in_argument_value() {
    let input = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/type-in-argument-value.graphql"
    );
    let expected = include_str!(
        "parse_executable_document_with_error_recovery/fixtures/type-in-argument-value.expected"
    );
    test_fixture(
        transform_fixture,
        file!(),
        "type-in-argument-value.graphql",
        "parse_executable_document_with_error_recovery/fixtures/type-in-argument-value.expected",
        input,
        expected,
    )
