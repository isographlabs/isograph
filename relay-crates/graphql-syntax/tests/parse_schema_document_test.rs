...
async fn directive_description() {
    ...
    test_fixture(
        transform_fixture,
        file!(),
        "directive_description.graphql",
        "parse_schema_document/fixtures/directive_description.expected",
        input,
        expected,
    )
    .await;
...
async fn field_description() {
    ...
    test_fixture(
        ...
        "parse_schema_document/fixtures/field_description.expected",
        input,
        expected,
    )
    .await;
...
async fn schema_kitchen_sink() {
    ...
    test_fixture(
        ...
        "parse_schema_document/fixtures/schema_kitchen_sink.expected",
        input,
        expected,
    )
    .await;
...
async fn schema_with_leading_comment() {
    ...
    let expected =
        include_str!("parse_schema_document/fixtures/schema_with_leading_comment.expected");
    test_fixture(
        transform_fixture,
        file!(),
        "schema_with_leading_comment.graphql",
        "parse_schema_document/fixtures/schema_with_leading_comment.expected",
        input,
        expected,
    )
    .await;
...
async fn type_definition() {
    ...
    test_fixture(
        ...
        "parse_schema_document/fixtures/type_definition.expected",
        input,
        expected,
    )
    .await;
