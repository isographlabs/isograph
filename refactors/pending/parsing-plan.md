...
2. `extract-iso-literals.md`. `THostLanguage: HostLanguage` extracts iso literals from a file and validates the host embedding. `TypeScriptHostLanguage` is the first implementor.
