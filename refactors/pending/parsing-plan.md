...
1. `generic-slot.md`. Generic `Slot` impl, `UnparsedChunkItemsParent`, `SlotPath` enum. A gap in the slot span answers `IsographResolutionNode::Slot`. Leftover span stays tight.
