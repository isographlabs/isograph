...
One shippable change. An e2e that uses `isograph send` then `semanticTokens/full` is e2e-send-semantic-tokens.md. Send does not wait for ingest; that e2e settles once, then asks.
