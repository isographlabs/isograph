...
- entrypoint
- field + optional "to X", i.e. pointers are not separate keyword. optional-to.md is the parser change: `target_type: Option<WithSpan<TypeAnnotation>>` on `FieldDeclaration`
