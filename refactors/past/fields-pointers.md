...
- entrypoint
- field + optional "to X", i.e. pointers are not separate keyword. The parser type is `SelectableDeclaration`. `target_type: Option<WithSpan<TypeAnnotation>>` is optional-to.md.
