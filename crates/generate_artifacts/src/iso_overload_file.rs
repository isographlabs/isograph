...
use crate::generate_artifacts::{print_javascript_type_declaration, ISO_TS_FILE_NAME};
...
pub(crate) fn build_iso_overload_artifact<TNetworkProtocol: NetworkProtocol>(
    ...
    let mut imports = "import type { IsographEntrypoint, Link } from '@isograph/react';\n".to_string();
