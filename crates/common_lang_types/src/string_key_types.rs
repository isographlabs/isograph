...
string_key_one_way_conversion!(from: IsographObjectTypeName, to: UnvalidatedTypeName);
...
string_key_one_way_conversion!(from: GraphQLUnionTypeName, to: IsographObjectTypeName);

string_key_one_way_conversion!(from: GraphQLObjectTypeName, to: OutputTypeName);
string_key_one_way_conversion!(from: GraphQLScalarTypeName, to: OutputTypeName);
...
string_key_one_way_conversion!(from: GraphQLScalarTypeName, to: InputTypeName);
...
string_key_one_way_conversion!(from: GraphQLScalarTypeName, to: UnvalidatedTypeName);
