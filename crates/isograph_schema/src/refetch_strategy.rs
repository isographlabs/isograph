...
use isograph_lang_types::{
    ArgumentKeyAndValue, EmptyStruct, ScalarFieldSelection, ScalarFieldSelectionVariant,
...
pub fn id_selection(
) -> WithSpan<ServerFieldSelection<ScalarFieldSelectionVariant, ScalarFieldSelectionVariant>> {
    WithSpan::new(
