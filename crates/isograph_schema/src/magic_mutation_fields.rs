...
impl UnvalidatedSchema {
    ...
    fn validate_magic_mutation_directive(
        ...
        let mutation_info: MagicMutationFieldInfo = from_graphql_directive(d)?;
...
fn from_graphql_directive<'a, T: Deserialize<'a>>(
    directive: &GraphQLDirective<ConstantValue>,
) -> ProcessTypeDefinitionResult<T> {
    T::deserialize(GraphQLDirectiveDeserailizer)
}

struct GraphQLDirectiveDeserailizer {}

impl Deserializer for GraphQLDirectiveDeserailizer {
