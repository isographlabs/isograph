...
import { type Economist__omitted__param } from './Economist/omitted/param_type';
...
export function iso<T>(
  param: T & MatchesWhitespaceAndString<'field Economist.omitted', T>
): IdentityWithParam<Economist__omitted__param>;
