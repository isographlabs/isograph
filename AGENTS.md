...
- Selection, Selectable, and SelectionSet are defined in `mental-model.md`. Do not name a selection node `Selectable*`. Checking that a selection refers to a selectable that exists is a later pass.
