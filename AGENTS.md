...
The schema data model is `docs-website/docs/design-docs/mental-model.md`. Read it before working on entities, wrappers, selectables, field definitions, selections, selection sets, or entrypoints.
