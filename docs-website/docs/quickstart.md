...
Install [the Isograph VSCode extenion](https://marketplace.visualstudio.com/items?itemName=isograph.isograph). (For cursor, etc. you can install the extension from the vsix.)
...
If you run into issues with the installation/running of Isograph, checkout [troubleshooting](/docs/troubleshooting)
